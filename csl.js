...
CSL_E4X.prototype.addMissingNameNodes = function(myxml) {
    default xml namespace = "http://purl.org/net/xbiblio/csl"; with({});
    for each (var node in myxml..names) {
        ...
        if ("xml" == typeof node && node.elements("name").length() > 0) {
            if (node.institution.length() === 0) {
                institution_long = <institution
                    ...
                    use-last="1"/>
                var institution_part = <institution-part name="long"/>;
...
CSL_E4X.prototype.flagDateMacros = function(myxml) {
    default xml namespace = "http://purl.org/net/xbiblio/csl"; with({});
    for each (var node in myxml..macro) {
        if (node..date.length()) {
...
CSL.Parallel.prototype.CloseCite = function () {
    var x, pos, len, has_issued, use_journal_info, volume_pos, container_title_pos, collection_number_pos, section_pos;
    if (this.use_parallels) {
